...
from examples.Machine_learning.CNN.Problems import CNN_Pascal_VOC, ResNet_Pascal_VOC
...
def f1():
    ...
    problem = CNN_Pascal_VOC.CNNPascalVoc(learning_rate, fc_size)
...
def f2():
    learning_rate = {'low': 0.0001, 'up': 0.001}
